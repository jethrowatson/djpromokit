...
export default function BioDashboardSection({ profile, pressShotsCount, featuredMixesCount, socialLink }: BioDashboardProps) {
            ...
            <div>
                ...
                {hasBio ? (
                    ...
                    <div className="glass-panel p-8 rounded-3xl border-purple-500/30 bg-purple-900/10 text-center flex flex-col items-center justify-center relative overflow-hidden h-full">
                        ...
                        <h3 className="text-lg font-bold text-white mb-2 relative z-10">Create your DJ biography with AI.</h3>
                        <p className="text-slate-400 text-sm mb-6 max-w-md mx-auto relative z-10">
                            Answer a few questions and our AI will instantly generate an engaging biography ready for your press kit.
                        </p>
                        <button
                            onClick={() => setShowAI(true)}
