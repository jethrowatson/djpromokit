                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative glass-panel rounded-3xl p-2 border-white/10 shadow-2xl overflow-hidden aspect-[9/16] md:aspect-auto md:h-[600px] flex justify-center items-center bg-slate-900">
                                {/* Mockup visual */}
                                <div className="text-center p-8">
                                    <h3 className="text-2xl font-bold text-white mb-4 opacity-50">EPK Preview</h3>
                                    <p className="text-slate-500">Wait till you see your mixes here.</p>
                                    <Play className="w-16 h-16 text-slate-700 mx-auto mt-6" />
                                </div>
                            </div>
                        </div>
                    </div>
