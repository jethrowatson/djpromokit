...
import { Disc3, Mail, Lock, User, AtSign, ArrowRight } from "lucide-react";
        ...
        <div className="min-h-[calc(100vh-4rem)] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-slate-950 relative overflow-hidden">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                <Link href="/" className="flex justify-center items-center gap-2 mb-8 group">
                    <Disc3 className="w-10 h-10 text-cyan-500 group-hover:text-purple-400 transition-colors duration-300" />
                    <span className="font-bold text-2xl tracking-tight text-white">DJpromokit<span className="text-cyan-500 group-hover:text-purple-500 transition-colors">.com</span></span>
                </Link>
