...
// Extremely basic security - only allow running this once, or require an auth token
// For now, we'll just allow it since the EPK examples are meant to be public
export async function GET(req: Request) {
    const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || '';
    const supabaseServiceKey = process.env.SUPABASE_SERVICE_ROLE_KEY || '';

    if (!supabaseUrl || !supabaseServiceKey) {
        return NextResponse.json({ error: "Missing DB keys in Vercel." }, { status: 500 });
    }
    ...
    const examples = [
        {
            ...
            tracks: [
                { title: "Defected Croatia Set", url: "https://www.youtube.com/watch?v=LqA-qH3rS2s" },
                { title: "Ibiza Closing Party", url: "https://www.youtube.com/watch?v=N6JtAEx6WGE" }
            ],
            gigs: [
        ...
        },
        {
            ...
            tracks: [
                { title: "Peak Time Wedding Mix 2024", url: "https://www.youtube.com/watch?v=kYJj0pEQ_qI" }
            ],
            gigs: [
        ...
        },
        {
            ...
            tracks: [
                { title: "Classic Hip Hop & R&B Mix", url: "https://www.youtube.com/watch?v=8b9e8R-HkWE" }
            ],
            gigs: [
        ...
        },
        {
            ...
            tracks: [
                { title: "UKF On Air: Rampage", url: "https://www.youtube.com/watch?v=5rM3IitL2Qc" }
            ],
            gigs: [
        ...
        },
        {
            ...
            tracks: [
                { title: "Cercle Live Set - Deep House", url: "https://www.youtube.com/watch?v=tP5E9S2sMkw" }
            ],
            gigs: [
        ...
        },
        {
            ...
            tracks: [
                { title: "Tomorrowland Mainstage Live", url: "https://www.youtube.com/watch?v=M0Z-3K_V2K8" }
            ],
            gigs: [
        ...
        for (const ex of examples) {
            ...
            if (existingProfiles && existingProfiles.length > 0) {
                ...
                if (authError || !authData.user) {
                    console.error(`Failed auth user ${ex.username}:`, authError);
                    continue;
                }
                userId = authData.user.id;
            }

            // small wait for triggers
            ...
            // 4. Insert media (avatar as press shot + mix tracks as featured mixes)
            ...
            // 6. Socials
            await supabaseAdmin.from('social_links').upsert({
                profile_id: userId,
                instagram: "https://instagram.com",
                soundcloud: "https://soundcloud.com"
            }, { onConflict: 'profile_id' });

            results.push(`Seeded ${ex.name}`);
        }
